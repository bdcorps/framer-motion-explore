const source = `import { MoonIcon } from "@chakra-ui/icons";
import {
  Box,
  Button,
  chakra,
...
export default function App() {
  return (
    <Center w="full" h="100vh" pt={10} backgroundColor="purple.50">
        <Onboarding />
    </Center>
  );
};
...
const animation = {
  name: "SaaS Onboarding modal",
  slug: "saas-onboarding-modal",
  description: "Well designed onboarding modal with multiple screens to be used in a SaaS application to introduce critical features to new users. The elements subtly animate in when the arrow keys are pressed to move forward.",
  source,
}
